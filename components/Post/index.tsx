  ...
  return (
    ...
    <div className="flex w-fit flex-col items-stretch bg-secondary-100 shadow-2xl">
      ...
      <div className="flex flex-row flex-nowrap gap-4 p-4">
        <svg onClick={()=>{setShowThread(q=>!q)}} height="800px" width="800px" version="1.1" className="w-8 cursor-pointer h-8" xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 29.338 29.338">
<g>
	<path className='fill-primary-600' d="M27.184,1.605H2.156C0.967,1.605,0,2.572,0,3.76v17.572c0,1.188,0.967,2.155,2.156,2.155h13.543
      ...
      {showThread?<>
        ...
        <div className="ml-32">
          {
            <div className="bg-secondary-100 shadow-2xl p-4">
              <div className="flex flex-row gap-4 p-2">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <h3 className="text-sm text-secondary-700">{new Date(comment.posted).toLocaleString()}</h3>
        </div>
      </div>
      <div className="prose m-8 bg-secondary-200 p-4">
        <Markdown
        ...
        <div className="bg-secondary-100 shadow-2xl p-2">
            <h2 className="text-xl m-2">Write a comment</h2>

          <PostEditor submit={async (content, setalert)=>{
